            ...
            <div class="relative z-10 flex flex-col justify-center px-12 xl:px-20 text-white">
                ...
                <div class="space-y-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="font-bold text-lg">Top Employers</h3>
                            <p class="text-blue-200 text-sm">Access jobs from verified, high-quality companies.</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <h3 class="font-bold text-lg">Fast Applications</h3>
                            <p class="text-blue-200 text-sm">Apply to jobs in seconds with your saved profile.</p>
                        </div>
                    </div>
                </div>
            </div>
