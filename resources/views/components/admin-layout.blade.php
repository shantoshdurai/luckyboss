...
<body class="min-h-screen bg-[#f8fafc] text-text-primary antialiased" x-data="{ 
    ...
    <div class="flex min-h-screen">
        ...
        >
            ...
            {{-- Navigation Items --}}
            <nav class="flex-1 overflow-y-auto py-2 px-3 space-y-1.5 scrollbar-thin">
                ...
                <div>
                    <button @click="toggleDropdown('employers')" type="button" @class(['w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-bold transition-all group cursor-pointer', 'bg-navy text-white shadow-xs' => $isEmployers, 'text-slate-700 hover:text-navy hover:bg-slate-100 font-semibold' => !$isEmployers])>
                        ...
                        <svg x-show="sidebarOpen" :class="openDropdowns.employers ? 'rotate-180' : ''" class="w-3.5 h-3.5 {{ $isEmployers ? 'text-white/80' : 'text-slate-400' }} transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                    </button>
                    <div x-show="openDropdowns.employers && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.companies.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.companies.index') && !request('status'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !(request()->routeIs('admin.companies.index') && !request('status'))])>All Companies</a>
                        <a href="{{ route('admin.companies.index', ['status' => 'pending']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('status') === 'pending', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('status') !== 'pending'])>Pending Approval</a>
                        <a href="{{ route('admin.companies.index', ['status' => 'verified']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('status') === 'verified', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('status') !== 'verified'])>Approved Companies</a>
                        <a href="{{ route('admin.employer-users.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.employer-users.*'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->routeIs('admin.employer-users.*')])>Employer Users</a>
                        <a href="{{ route('admin.employer-documents.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.employer-documents.*'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->routeIs('admin.employer-documents.*')])>Employer Documents</a>
                        <a href="{{ route('admin.employer-notes.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.employer-notes.*'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->routeIs('admin.employer-notes.*')])>Employer Notes</a>
                    </div>
                </div>
                ...
                <div>
                    <button @click="toggleDropdown('jobSeekers')" type="button" @class(['w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-bold transition-all group cursor-pointer', 'bg-navy text-white shadow-xs' => $isSeekers, 'text-slate-700 hover:text-navy hover:bg-slate-100 font-semibold' => !$isSeekers])>
                        ...
                        <svg x-show="sidebarOpen" :class="openDropdowns.jobSeekers ? 'rotate-180' : ''" class="w-3.5 h-3.5 {{ $isSeekers ? 'text-white/80' : 'text-slate-400' }} transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                    </button>
                    <div x-show="openDropdowns.jobSeekers && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.candidates.index', ['view' => 'all-job-seekers']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'all-job-seekers' || (request()->routeIs('admin.candidates.index') && !request('view')), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !(request('view') === 'all-job-seekers' || (request()->routeIs('admin.candidates.index') && !request('view')))])>All Job Seekers</a>
                        <a href="{{ route('admin.candidates.index', ['view' => 'verified-candidates']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'verified-candidates', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'verified-candidates'])>Verified Candidates</a>
                        <a href="{{ route('admin.candidates.index', ['view' => 'incomplete-profiles']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'incomplete-profiles', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'incomplete-profiles'])>Incomplete Profiles</a>
                        <a href="{{ route('admin.candidates.index', ['view' => 'candidate-resumes']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'candidate-resumes', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'candidate-resumes'])>Candidate Resumes</a>
                        <a href="{{ route('admin.candidates.index', ['view' => 'candidate-skills']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'candidate-skills', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'candidate-skills'])>Candidate Skills</a>
                    </div>
                </div>
                ...
                <div>
                    <button @click="toggleDropdown('jobs')" type="button" @class(['w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-bold transition-all group cursor-pointer', 'bg-navy text-white shadow-xs' => $isJobs, 'text-slate-700 hover:text-navy hover:bg-slate-100 font-semibold' => !$isJobs])>
                        ...
                        <svg x-show="sidebarOpen" :class="openDropdowns.jobs ? 'rotate-180' : ''" class="w-3.5 h-3.5 {{ $isJobs ? 'text-white/80' : 'text-slate-400' }} transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                    </button>
                    <div x-show="openDropdowns.jobs && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.jobs.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.jobs.index') && !request('view'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !(request()->routeIs('admin.jobs.index') && !request('view'))])>All Jobs</a>
                        <a href="{{ route('admin.jobs.index', ['view' => 'pending-approval']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'pending-approval', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'pending-approval'])>Pending Approval</a>
                        <a href="{{ route('admin.jobs.index', ['view' => 'featured-jobs']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'featured-jobs', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'featured-jobs'])>Featured Jobs</a>
                        <a href="{{ route('admin.jobs.create') }}" class="block py-1.5 px-2.5 rounded-lg text-secondary-600 hover:text-navy font-bold">+ Post New Job</a>
                    </div>
                </div>
                ...
                <div>
                    <button @click="toggleDropdown('recruitment')" type="button" @class(['w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-bold transition-all group cursor-pointer', 'bg-navy text-white shadow-xs' => $isRecruit, 'text-slate-700 hover:text-navy hover:bg-slate-100 font-semibold' => !$isRecruit])>
                        ...
                        <svg x-show="sidebarOpen" :class="openDropdowns.recruitment ? 'rotate-180' : ''" class="w-3.5 h-3.5 {{ $isRecruit ? 'text-white/80' : 'text-slate-400' }} transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                    </button>
                    <div x-show="openDropdowns.recruitment && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.recruitment.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.recruitment.index') && !request('tab'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !(request()->routeIs('admin.recruitment.index') && !request('tab'))])>All Applications</a>
                        <a href="{{ route('admin.recruitment.index', ['tab' => 'pipeline']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('tab') === 'pipeline', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('tab') !== 'pipeline'])>Kanban Board</a>
                        <a href="{{ route('admin.recruitment.index', ['tab' => 'interviews']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('tab') === 'interviews', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('tab') !== 'interviews'])>Interview Scheduled</a>
                        <a href="{{ route('admin.recruitment.index', ['tab' => 'offers']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('tab') === 'offers', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('tab') !== 'offers'])>Offer Letters</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div x-show="openDropdowns.subscriptions && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.operations.index', 'packages') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->is('admin/operations/packages*'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->is('admin/operations/packages*')])>Packages</a>
                        <a href="{{ route('admin.subscriptions.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.subscriptions.index') && !request('view'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !(request()->routeIs('admin.subscriptions.index') && !request('view'))])>Active Subscriptions</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div x-show="openDropdowns.payments && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.payments.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.payments.index') && !request('view'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !(request()->routeIs('admin.payments.index') && !request('view'))])>All Transactions</a>
                        <a href="{{ route('admin.payments.index', ['view' => 'employer-payments']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'employer-payments', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'employer-payments'])>Employer Payments</a>
                        <a href="{{ route('admin.payments.index', ['view' => 'job-seeker-payments']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'job-seeker-payments', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'job-seeker-payments'])>Job Seeker Payments</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div x-show="openDropdowns.aiApi && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.ai-api.index', ['view' => 'global-ai-settings']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'global-ai-settings', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'global-ai-settings'])>Feature Flags</a>
                        <a href="{{ route('admin.ai-api.index', ['view' => 'platform-ai']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'platform-ai', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'platform-ai'])>Platform AI</a>
                        <a href="{{ route('admin.ai-api.index', ['view' => 'employer-byoai']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'employer-byoai', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'employer-byoai'])>Employer BYOAI</a>
                        <a href="{{ route('admin.ai-api.index', ['view' => 'resume-parser']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'resume-parser', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'resume-parser'])>Resume Parser</a>
                        <a href="{{ route('admin.ai-api.index', ['view' => 'api-usage']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'api-usage', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'api-usage'])>API Usage</a>
                        <a href="{{ route('admin.ai-api.index', ['view' => 'api-errors']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'api-errors', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'api-errors'])>API Errors</a>
                        <a href="{{ route('admin.ai-api.index', ['view' => 'cost-monitoring']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request('view') === 'cost-monitoring', 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => request('view') !== 'cost-monitoring'])>Cost Monitoring</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div x-show="openDropdowns.mobileApps && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.command.show', ['mobile-apps', 'job-seeker-app-settings']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->is('admin/command/mobile-apps/job-seeker-app-settings'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->is('admin/command/mobile-apps/job-seeker-app-settings')])>Job Seeker App</a>
                        <a href="{{ route('admin.command.show', ['mobile-apps', 'employer-app-settings']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->is('admin/command/mobile-apps/employer-app-settings'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->is('admin/command/mobile-apps/employer-app-settings')])>Employer App</a>
                        <a href="{{ route('admin.command.show', ['mobile-apps', 'minimum-app-version']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->is('admin/command/mobile-apps/minimum-app-version'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->is('admin/command/mobile-apps/minimum-app-version')])>App Version</a>
                        <a href="{{ route('admin.command.show', ['mobile-apps', 'maintenance-mode']) }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->is('admin/command/mobile-apps/maintenance-mode'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->is('admin/command/mobile-apps/maintenance-mode')])>Maintenance Mode</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div x-show="openDropdowns.interviews && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.interviews.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.interviews.index') && !request('view'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !(request()->routeIs('admin.interviews.index') && !request('view'))])>All Interviews</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div x-show="openDropdowns.notifications && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.notifications.index') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.notifications.index'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->routeIs('admin.notifications.index')])>Notification History</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div x-show="openDropdowns.settings && sidebarOpen" x-cloak class="mt-1 pl-9 pr-2 space-y-1 text-xs border-l-2 border-slate-200 ml-5">
                        <a href="{{ route('admin.site-settings.edit') }}" @class(['block py-1.5 px-2.5 rounded-lg text-xs transition-all', 'bg-navy text-white font-bold shadow-xs' => request()->routeIs('admin.site-settings.*'), 'text-slate-600 hover:text-navy hover:bg-slate-100 font-medium' => !request()->routeIs('admin.site-settings.*')])>Branding & Contact</a>
                    </div>
                </div>
