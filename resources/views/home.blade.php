<x-layouts.app title="Lucky Boss Portal | Elite AI-Powered Recruitment Platform">
    ...
    <section class="min-h-[calc(100vh-80px)] flex flex-col justify-center text-white py-12 lg:py-16 relative overflow-hidden bg-cover bg-right bg-no-repeat"
        ...
        <div class="container mx-auto px-6 relative z-10 text-center max-w-5xl">
            ...
            {{-- Premium Animated Platform Metrics (Luxury Frosted Glass Card) --}}
            <div class="mt-14 max-w-4xl mx-auto p-3 sm:p-5 rounded-3xl bg-white/[0.07] border border-white/15 backdrop-blur-xl shadow-2xl">
                <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10 font-sans">
                    {{-- 1. Verified Jobs --}}
                    <div class="py-4 px-4 flex flex-col items-center justify-center text-center group transition-all duration-300 hover:bg-white/[0.04] rounded-2xl" x-data="counter(5240, 1800)" x-intersect.once="start()">
                        <div class="w-12 h-12 rounded-2xl bg-emerald-500/20 border border-emerald-400/30 flex items-center justify-center mb-3 shadow-inner group-hover:scale-110 group-hover:border-emerald-400 transition-all duration-300">
                            <svg class="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 00.75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 00-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0112 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 01-.673-.38m0 0A2.18 2.18 0 013 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 013.413-.387m7.5 0V5.25A2.25 2.25 0 0013.5 3h-3a2.25 2.25 0 00-2.25 2.25v.894m7.5 0a48.667 48.667 0 00-7.5 0M12 12.75h.008v.008H12v-.008z" />
                            </svg>
                        </div>
                        <div class="text-3xl sm:text-4xl lg:text-5xl font-heading font-black tracking-tight text-white drop-shadow-md" x-text="display">5,240+</div>
                        <div class="text-xs sm:text-sm font-bold text-slate-100 uppercase tracking-widest mt-2">Verified Jobs</div>
                        <div class="text-[11px] text-emerald-300 font-semibold mt-1 flex items-center gap-1">
                    ...
                    {{-- 2. Top Employers --}}
                    <div class="py-4 px-4 flex flex-col items-center justify-center text-center group transition-all duration-300 hover:bg-white/[0.04] rounded-2xl" x-data="counter(1450, 1800)" x-intersect.once="start()">
                        <div class="w-12 h-12 rounded-2xl bg-amber-500/20 border border-amber-400/30 flex items-center justify-center mb-3 shadow-inner group-hover:scale-110 group-hover:border-amber-400 transition-all duration-300">
                            <svg class="w-6 h-6 text-amber-300" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                        ...
                        <div class="text-3xl sm:text-4xl lg:text-5xl font-heading font-black tracking-tight text-white drop-shadow-md" x-text="display">1,450+</div>
                        <div class="text-xs sm:text-sm font-bold text-slate-100 uppercase tracking-widest mt-2">Top Employers</div>
                        <div class="text-[11px] text-amber-300 font-semibold mt-1 flex items-center gap-1">
                            <span class="w-1.5 h-1.5 rounded-full bg-amber-400 animate-pulse"></span>
                            <span>Direct Enterprises</span>
                        </div>
                    </div>

                    {{-- 3. Candidate Profiles --}}
                    <div class="py-4 px-4 flex flex-col items-center justify-center text-center group transition-all duration-300 hover:bg-white/[0.04] rounded-2xl" x-data="counter(45000, 2000)" x-intersect.once="start()">
                        <div class="w-12 h-12 rounded-2xl bg-sky-500/20 border border-sky-400/30 flex items-center justify-center mb-3 shadow-inner group-hover:scale-110 group-hover:border-sky-400 transition-all duration-300">
                            <svg class="w-6 h-6 text-sky-300" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                            </svg>
                        </div>
                        <div class="text-3xl sm:text-4xl lg:text-5xl font-heading font-black tracking-tight text-white drop-shadow-md" x-text="display">45,000+</div>
                        <div class="text-xs sm:text-sm font-bold text-slate-100 uppercase tracking-widest mt-2">Candidate Profiles</div>
                        <div class="text-[11px] text-sky-300 font-semibold mt-1 flex items-center gap-1">
